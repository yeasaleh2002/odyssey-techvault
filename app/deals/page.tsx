            ...
            {dealProducts.map((product, index) => {
              ...
              return (
                ...
                >
                  <Link
                    href={`/items/${pid}`}
                    className="group bg-card border border-border rounded-2xl overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5 flex flex-col h-full"
                  >
                    <div className="relative h-48 bg-muted overflow-hidden">
                      ...
                      {discountPct && (
                        <div className="absolute top-3 right-12 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-full">
                          -{discountPct}%
                        </div>
                      )}
                      <button
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      ...
                      <button
                        ...
                        className={`w-full flex items-center justify-center gap-2 py-2 rounded-xl text-sm font-semibold transition-all ${
                          isAdding ? "bg-green-500 text-white" : "bg-primary text-primary-foreground hover:opacity-90"
                        }`}
                      >
